...
import com.zephira.pogtweaks.item.ExampleItem;
...
public class ItemInit {
    ...
    public static final RegistryObject<Item> EXAMPLE_ITEM = register("example_item", () -> new ExampleItem(new Item.Properties().tab(PogTweaks.TWEAKS_TAB)));
